...
public class AdminController {
    ...
    @ModelAttribute
    public void getStudentsWithBacklog(Model m) {

        List<Student> backlogStudents = this.studentService.getAllStudents()
                .stream()
                .filter(Student::isBacklog)
                .collect(Collectors.toList());

        m.addAttribute("backlogStudents", backlogStudents);
